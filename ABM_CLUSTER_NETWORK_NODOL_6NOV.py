...
#for g in range(0,len(wed_seq)):
    ...
    G2=G_list_width[g]
    if g in range(25, 30):
        nx.set_node_attributes(G, {'3': 'JUNC'}, 'TYPE')
        nx.set_node_attributes(G, {'58': 'JUNC'}, 'TYPE')
        nx.set_node_attributes(G, {'23': 'JUNC'}, 'TYPE')
        nx.set_node_attributes(G, {'14': 'JUNC'}, 'TYPE')
        nx.set_node_attributes(G, {'4': 'END'}, 'TYPE')
        nx.set_node_attributes(G, {'181': 'JUNC'}, 'TYPE')
        #nx.set_node_attributes(G, {'58': 'JUNC'}, 'TYPE')
        nx.set_node_attributes(G, {'89': 'JUNC'}, 'TYPE')
        nx.set_node_attributes(G, {'9': 'JUNC'}, 'TYPE')
        nx.set_node_attributes(G, {'155': 'JUNC'}, 'TYPE')
    if g in range(50, 55):
        nx.set_node_attributes(G, {'8': 'JUNC'}, 'TYPE')
        nx.set_node_attributes(G, {'13': 'JUNC'}, 'TYPE')
        nx.set_node_attributes(G, {'44': 'JUNC'}, 'TYPE')
        nx.set_node_attributes(G, {'16': 'CHAM'}, 'TYPE')
        nx.set_node_attributes(G, {'42': 'JUNC'}, 'TYPE')
        nx.set_node_attributes(G, {'90': 'CHAM'}, 'TYPE')
        nx.set_node_attributes(G, {'91': 'CHAM'}, 'TYPE')
        nx.set_node_attributes(G, {'68': 'CHAM'}, 'TYPE')
        nx.set_node_attributes(G, {'58': 'CHAM'}, 'TYPE')
    #list_ant=[]
...
#                             print(n, ant)
    ...
    save_directory=directory+'/DOL_RESULTS'
    ...
    mega_df = pd.DataFrame(data)
    mega_df = mega_df.reset_index(drop=True)
    mega_df.to_csv(save_directory+'/_SUMMARY_DOL'+'_'+strits+'_'+name+'_'+stramp+'.csv',index=False)
